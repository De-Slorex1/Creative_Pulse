  ...
  return (
    <div className="bg-[url('/bg.png')] bg-cover bg-no-repeat w-full p-0 m-0">
        ...
        <div className='text-center mt-24'>
            <p className='text-lighter-grey text-xl uppercase leading-10'>our services</p>
            <h1 className='text-grey text-5xl leading-2 py-2'>
                Creating Unique Experiences For<br/>
                Unconventional Designs
            </h1>
            <p className='text-lighter-grey leading-10 py-0'>The modular mix and match solution for your business</p>
        </div>
        ...
        <div className='flex flex-row justify-around mx-14 py-20'>
            ...
            <div>
                <p className='text-lighter-grey leading-6 font-thin text-lg'>
                    With a deep passion for design and technology, we've found our <br/>
                ...
                <button className="px-10 my-2 font-normal text-grey text-md border bg-transparent rounded-full py-2 hover:bg-light-orange hover:border-none">Book A Call</button>
            </div>
        </div>
        <div className='flex flex-col justify-center items-center w-full px-44 mb-22'>
            <div className="bg-[url('/frame2.png')] bg-cover bg-no-repeat rounded-3xl w-full h-[300px] px-8 py-10 mx-2">
                ...
                <button className="px-6 my-2 font-normal text-grey bg-black text-white text-md border border-black rounded-full py-2 hover:bg-light-orange hover:border-none">Start Your Project</button>
            </div>
        </div>
        <div className='w-full py-16 flex flex-col px-44'>
            <div>
            ...
            <div className='flex flex-col justify-center items-center'>
                <button className="px-8 font-medium text-white text-md bg-light-orange rounded-full py-2 hover:bg-transparent hover:border">View More</button>
            </div>
        </div>
        <div className='flex flex-col justify-center items-center w-full px-44 py-16'>
            <div className="bg-[url('/frame3.png')] bg-cover bg-no-repeat rounded-3xl w-full h-[280px] px-8 py-10 mx-2">
                <h2 className='text-center font-medium text-5xl'>We've Worked On Over </h2>
                <div>
        ...
        <div className='flex flex-col justify-center items-center w-full px-44 py-16'>
            <div className="bg-[url('/frame4.png')] bg-cover bg-no-repeat rounded-3xl w-full h-[350px] px-8 py-12 mx-2">
                ...
                <button className="px-8 my-2 font-normal bg-black text-grey text-base border border-black rounded-full py-2 hover:bg-light-orange hover:border-none">Book A Call</button>
            </div>
        </div>
        <FAQsPage />            
    </div>
